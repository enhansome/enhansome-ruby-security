...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,201 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,725 | 🐛 16 | 🌐 Go | 📅 2026-08-03 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,003 | 🐛 75 | 🌐 C# | 📅 2026-08-14 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities. Also has support for CLI so it can be integrated into CI/CD pipeline.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 8 | 🌐 Ruby | 📅 2026-08-15 - Open source database of security advisories that are relevant to Ruby libraries.
