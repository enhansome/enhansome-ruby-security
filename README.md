...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,183 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Rack::Attack](https://github.com/kickstarter/rack-attack) ⭐ 5,761 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 - Middleware for blocking and throttling requests.
...
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,005 | 🐛 79 | 🌐 C# | 📅 2026-09-14 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities. Also has support for CLI so it can be integrated into CI/CD pipeline.
