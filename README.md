...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,573 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [secure-headers](https://github.com/twitter/secure_headers) ⭐ 3,228 | 🐛 13 | 🌐 Ruby | 📅 2026-07-27 - Manages application of security headers with many safe defaults.
...
* [ban-sensitive-files](https://github.com/bahmutov/ban-sensitive-files) ⭐ 69 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-26 - Checks filenames to be committed against a library of filename rules to prevent storing sensitive files in Git. Checks some files for sensitive contents (for example authToken inside .npmrc file).
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 3 | 🌐 Ruby | 📅 2026-08-29 - Open source database of security advisories that are relevant to Ruby libraries.
