...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,345 | 🐛 106 | 📅 2026-08-21 list thing.*
...
* [Ronin](https://github.com/ronin-rb/ronin) ⭐ 754 | 🐛 34 | 🌐 Ruby | 📅 2026-01-12 - Ronin is a free and Open Source Ruby toolkit for security research and development.
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,733 | 🐛 18 | 🌐 Go | 📅 2026-08-24 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 6 | 🌐 Ruby | 📅 2026-08-24 - Open source database of security advisories that are relevant to Ruby libraries.
