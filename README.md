...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,104 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,742 | 🐛 19 | 🌐 Go | 📅 2026-09-03 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
...
* [ban-sensitive-files](https://github.com/bahmutov/ban-sensitive-files) ⭐ 69 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-05 - Checks filenames to be committed against a library of filename rules to prevent storing sensitive files in Git. Checks some files for sensitive contents (for example authToken inside .npmrc file).
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,071 | 🐛 3 | 🌐 Ruby | 📅 2026-09-04 - Open source database of security advisories that are relevant to Ruby libraries.
