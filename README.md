...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,049 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [secure-headers](https://github.com/twitter/secure_headers) ⭐ 3,233 | 🐛 13 | 🌐 Ruby | 📅 2026-07-27 - Manages application of security headers with many safe defaults.
...
* [rails\_best\_practices](https://github.com/flyerhzm/rails_best_practices) ⭐ 4,162 | 🐛 61 | 🌐 Ruby | 📅 2026-04-23 - A static code analyzer for Ruby on Rails applications that finds - among other things - common patterns that might lead to security vulnerabilities.
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,717 | 🐛 16 | 🌐 Go | 📅 2026-08-03 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,002 | 🐛 75 | 🌐 C# | 📅 2026-08-12 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities. Also has support for CLI so it can be integrated into CI/CD pipeline.
...
* [ban-sensitive-files](https://github.com/bahmutov/ban-sensitive-files) ⭐ 69 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-11 - Checks filenames to be committed against a library of filename rules to prevent storing sensitive files in Git. Checks some files for sensitive contents (for example authToken inside .npmrc file).
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 11 | 🌐 Ruby | 📅 2026-08-12 - Open source database of security advisories that are relevant to Ruby libraries.
