...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,738 | 🐛 17 | 🌐 Go | 📅 2026-08-24 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 3 | 🌐 Ruby | 📅 2026-08-24 - Open source database of security advisories that are relevant to Ruby libraries.
