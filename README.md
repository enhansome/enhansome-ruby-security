...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,667 | 🐛 102 | 📅 2026-08-18 list thing.*
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,729 | 🐛 19 | 🌐 Go | 📅 2026-08-17 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 9 | 🌐 Ruby | 📅 2026-08-18 - Open source database of security advisories that are relevant to Ruby libraries.
