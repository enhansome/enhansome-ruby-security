...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,517 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Rack::Attack](https://github.com/kickstarter/rack-attack) ⭐ 5,762 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 - Middleware for blocking and throttling requests.
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,745 | 🐛 17 | 🌐 Go | 📅 2026-09-16 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,005 | 🐛 79 | 🌐 C# | 📅 2026-09-15 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities. Also has support for CLI so it can be integrated into CI/CD pipeline.
...
* [ban-sensitive-files](https://github.com/bahmutov/ban-sensitive-files) ⭐ 68 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-15 - Checks filenames to be committed against a library of filename rules to prevent storing sensitive files in Git. Checks some files for sensitive contents (for example authToken inside .npmrc file).
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 3 | 🌐 Ruby | 📅 2026-09-13 - Open source database of security advisories that are relevant to Ruby libraries.
