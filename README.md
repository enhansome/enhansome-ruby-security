...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,482 | 🐛 99 | 📅 2026-06-30 list thing.*
...
* [secure-headers](https://github.com/twitter/secure_headers) ⭐ 3,232 | 🐛 13 | 🌐 Ruby | 📅 2026-07-27 - Manages application of security headers with many safe defaults.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 9 | 🌐 Ruby | 📅 2026-08-13 - Open source database of security advisories that are relevant to Ruby libraries.
