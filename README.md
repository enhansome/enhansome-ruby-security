...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,079 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [ban-sensitive-files](https://github.com/bahmutov/ban-sensitive-files) ⭐ 69 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-07 - Checks filenames to be committed against a library of filename rules to prevent storing sensitive files in Git. Checks some files for sensitive contents (for example authToken inside .npmrc file).
