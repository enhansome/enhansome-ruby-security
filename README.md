...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,888 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,744 | 🐛 25 | 🌐 Go | 📅 2026-09-14 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 2 | 🌐 Ruby | 📅 2026-09-13 - Open source database of security advisories that are relevant to Ruby libraries.
