...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,655 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [Rack::Attack](https://github.com/kickstarter/rack-attack) ⭐ 5,762 | 🐛 19 | 🌐 Ruby | 📅 2026-07-02 - Middleware for blocking and throttling requests.
...
* [Bearer](https://github.com/Bearer/bearer) ⭐ 2,726 | 🐛 19 | 🌐 Go | 📅 2026-08-17 - A code security scanning tool (SAST) to discover, filter and prioritize security and privacy risks.
...
* [ruby-advisory-db](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 8 | 🌐 Ruby | 📅 2026-08-16 - Open source database of security advisories that are relevant to Ruby libraries.
